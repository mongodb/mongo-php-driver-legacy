...
extern zend_class_entry *mongo_ce_DB, *mongo_ce_Collection, *mongo_ce_Cursor;
extern zend_class_entry *mongo_ce_Exception, *mongo_ce_GridFSException;
extern zend_class_entry *mongo_ce_Id, *mongo_ce_Date, *mongo_ce_BinData;
extern zend_class_entry *mongo_ce_Int32, *mongo_ce_Int64;

ZEND_EXTERN_MODULE_GLOBALS(mongo);

zend_class_entry *mongo_ce_GridFS = NULL, *mongo_ce_GridFSFile = NULL;
