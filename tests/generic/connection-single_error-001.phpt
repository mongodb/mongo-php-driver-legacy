...
?>
--EXPECTF--
Fatal error: Uncaught exception 'MongoConnectionException' with message 'Couldn't connect to 'http:0': No such file or directory' in %sconnection-single_error-001.php:%d
Stack trace:
