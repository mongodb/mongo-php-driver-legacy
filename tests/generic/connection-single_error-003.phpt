...
?>
--EXPECTF--
Fatal error: Uncaught exception 'MongoConnectionException' with message 'Couldn't connect to 'foofas:5345': Couldn't get host info for foofas' in %sconnection-single_error-003.php:%d
Stack trace:
