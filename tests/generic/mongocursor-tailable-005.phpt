--TEST--
MongoCursor::tailable() with getNext() and hasNext() (dropping capped collection kills the cursor)
--SKIPIF--
...
while (++$i) {
    ...
    /* We cannot delete documents from a capped collection; however, dropping
     * the capped collection will cause the next OP_GET_MORE to fail.
     */
