...
?>
--EXPECTF--
PARSE   INFO: Parsing mongodb://%s:30000
PARSE   INFO: - Found node: %s:30000
...
CON     INFO: connection_create: creating new connection for %s:30000
CON     FINE: Connecting to tcp://%s:30000 (%s:30000;-;.;%d) with connection timeout: 30.000000
CON     INFO: stream_connect: Not establishing SSL for %s:30000
CON     FINE: Setting stream timeout to 30.000000
CON     INFO: ismaster: start
CON     FINE: No timeout changes for %s:30000;-;.;%d
...
CON     INFO: is_ping: pinging %s:30000;-;.;%d
CON     FINE: No timeout changes for %s:30000;-;.;%d
CON     FINE: send_packet: read from header: %d
CON     FINE: send_packet: data_size: %d
CON     FINE: No timeout changes for %s:30000;-;.;%d
...
REPLSET FINE: - connection: type: %s, socket: 42, ping: %d, hash: %s:30000;-;.;%d
...
REPLSET INFO: - connection: type: %s, socket: 42, ping: %d, hash: %s:30000;-;.;%d
