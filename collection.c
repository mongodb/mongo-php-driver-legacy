...
static zend_function_entry MongoCollection_methods[] = {
  ...
  PHP_ME(MongoCollection, getSlaveOkay, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_DEPRECATED)
  PHP_ME(MongoCollection, setSlaveOkay, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_DEPRECATED)
