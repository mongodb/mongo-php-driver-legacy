...
if test "$PHP_MONGO" != "no"; then
  ...
  PHP_NEW_EXTENSION(mongo, mongo.c mongo_types.c bson.c cursor.c collection.c db.c gridfs.c util/hash.c util/connect.c util/pool.c util/rs.c util/link.c, $ext_shared,, $PHP_MONGO_CFLAGS)
