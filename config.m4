...
if test "$PHP_MONGO" != "no"; then
  ...
  PHP_NEW_EXTENSION(mongo, php_mongo.c mongo.c mongo_types.c bson.c cursor.c collection.c db.c gridfs.c gridfs_stream.c util/hash.c util/log.c, $ext_shared,, $PHP_MONGO_CFLAGS)
