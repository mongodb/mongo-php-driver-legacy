...
/* {{{ proto MongoUpdateBatch MongoUpdateBatch::__construct(MongoCollection $collection)
...
PHP_METHOD(MongoUpdateBatch, __construct)
{
	...
	php_mongo_write_batch_ctor(intern, zcollection, MONGODB_API_COMMAND_UPDATE TSRMLS_CC);
}
/* }}} */
