...
zend_class_entry *mongo_ce_Date = NULL, *mongo_ce_BinData = NULL;
zend_class_entry *mongo_ce_DBRef = NULL, *mongo_ce_Id = NULL;
zend_class_entry *mongo_ce_Code = NULL, *mongo_ce_Regex = NULL;
zend_class_entry *mongo_ce_Timestamp = NULL, *mongo_ce_Int32 = NULL;
