...
#gcc -Wall -ggdb3 -O0 -o rp-test1 rp-test-complex1.c bson_helpers.c collection.c connections.c manager.c mini_bson.c parse.c read_preference.c str.c utils.c io.c
gcc -Wall -ggdb3 -O0 -o test3 parse-test2.c bson_helpers.c collection.c connections.c manager.c mini_bson.c parse.c read_preference.c str.c utils.c io.c
