...
int php_mongo_api_insert_single(buffer *buf, char *ns, char *collection, zval *doc, php_mongodb_write_options *write_options, mongo_connection *connection TSRMLS_DC);
